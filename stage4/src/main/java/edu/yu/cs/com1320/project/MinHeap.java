 ...
 * an element's array index, which is needed to reheapify an element after its last used time changes.
 * @param <E>
 */
public abstract class MinHeap<E extends Comparable>
{
     ...
     * both its children or is at the bottom of the heap (ie greatest element)
     */
